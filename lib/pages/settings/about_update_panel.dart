...
class AboutUpdatePanel extends ConsumerWidget {
  ...
  const AboutUpdatePanel({super.key, this.title});
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: FButton(
                        onPress: update.info?.matchedAsset == null
                            ? null
                            : () {
                                ref
                                    .read(appUpdateProvider.notifier)
...
class _Panel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OrbitaSettingsTileGroup(title: title, children: children);
  }
}
